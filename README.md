...
Create symbolic links for each scripts on your `$PATH` or install plugin manager like `zplug` and add following line to your shell configutation (bin/e.g. `.zshrc`) file.
